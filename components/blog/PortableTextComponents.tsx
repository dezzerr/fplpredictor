...
export const portableTextComponents: PortableTextComponents = {
  ...
  marks: {
    link: ({children, value}) => {
      ...
      if (external) {
        return (
          <a href={href} target="_blank" rel="noreferrer" className="text-fuchsia-300 underline underline-offset-4 hover:text-fuchsia-200">
            {children}
          </a>
        )
      }
      ...
      return (
        <a href={href} className="text-fuchsia-300 underline underline-offset-4 hover:text-fuchsia-200">
          {children}
        </a>
      )
    },
