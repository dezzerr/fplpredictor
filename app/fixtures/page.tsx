      ...
      <main className="container py-4 sm:py-6 px-3 sm:px-4">
        ...
        <div className="mb-4 sm:mb-6">
          <div className="flex items-center gap-2 sm:gap-3 mb-2">
            <div className="p-1.5 sm:p-2 bg-gradient-brand-cta rounded-lg shadow-glow-brand">
              <Calendar className="h-4 w-4 sm:h-5 sm:w-5 text-white" />
            </div>
            <div>
              <h1 className="font-display text-lg sm:text-2xl font-bold text-white">Fixture Analysis</h1>
